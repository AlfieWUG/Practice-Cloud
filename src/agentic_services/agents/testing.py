"""
TestingAgent - Migrates data to cloud
"""
...
1. Plan and execute test execution
...
Generate comprehensive data migration plans with specific steps, validation procedures, and rollback strategies."""
    ...
    async def execute(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not test_scenarios:
            raise ValueError("test_scenarios is required")
        ...
        try:
            ...
            migration_results = await self._plan_testing(project_id, test_scenarios, task)
            ...
            await self.emit_event(
                event_type='testing.failed',
                detail={'error': str(e)},
                project_id=project_id
            )
            raise
    
    async def _plan_testing(self, project_id: str, test_scenarios: Any, task: Dict[str, Any]) -> Dict[str, Any]:
