...
# Apply unified theme (includes chat window rendering)
apply_unified_theme()

# Import and render unified sidebar navigation (includes chat button)
from src.agentic_services.ui.unified_navigation import render_unified_sidebar
render_unified_sidebar()

# Check if project is selected
if not st.session_state.get('current_project'):
    st.error("No project selected. Please create a project first.")
...
# Professional Header
from src.agentic_services.ui.page_headers import render_professional_header
render_professional_header(
    "Cloud Credentials",
    f'Configure AWS access for <strong>{project["name"]}</strong>'
)
