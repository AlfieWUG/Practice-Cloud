"""
Tests for PerformanceOptimizerAgent
"""

import pytest
from unittest.mock import patch
from agentic_services.agents.performance_optimizer import PerformanceOptimizerAgent
...
@pytest.mark.asyncio
async def test_performance_optimizer_agent_initialization():
    """Test that PerformanceOptimizerAgent initializes correctly"""
    agent = PerformanceOptimizerAgent()
    
    assert agent.agent_id is not None
    assert agent.agent_type == "performance_optimizer"
    assert agent.optimization_data is None


@pytest.mark.asyncio
async def test_performance_optimizer_agent_with_custom_id():
    """Test PerformanceOptimizerAgent initialization with custom agent_id"""
    custom_id = "test-dependency-mapper-123"
    agent = PerformanceOptimizerAgent(agent_id=custom_id)
...
@pytest.mark.asyncio
async def test_performance_optimization_execution():
...
@pytest.mark.asyncio
async def test_performance_optimization_with_transitive_deps():
...
@pytest.mark.asyncio
async def test_performance_optimization_circular_detection():
...
@pytest.mark.asyncio
async def test_performance_optimization_compatibility_assessment():
...
@pytest.mark.asyncio
async def test_performance_optimization_vulnerability_check():
...
@pytest.mark.asyncio
async def test_performance_optimization_critical_paths():
...
@pytest.mark.asyncio
async def test_performance_optimization_missing_project_id():
    """Test error handling when project_id is missing"""
    agent = PerformanceOptimizerAgent()
    
    task = {
        'performance_metrics': [{'name': 'app'}]
    }
...
@pytest.mark.asyncio
async def test_performance_optimization_missing_performance_metrics():
    """Test error handling when performance_metrics are missing"""
    agent = PerformanceOptimizerAgent()
    ...
    with pytest.raises(ValueError, match="performance_metrics is required"):
        await agent.execute(task)


@pytest.mark.asyncio
async def test_performance_optimization_empty_performance_metrics():
    """Test handling of empty performance_metrics list"""
    agent = PerformanceOptimizerAgent()
...
@pytest.mark.asyncio
async def test_performance_optimization_state_persistence():
    """Test that mapping state is persisted to DynamoDB"""
    agent = PerformanceOptimizerAgent()
    
    task = {
        'project_id': 'project-606',
        'performance_metrics': [{'name': 'test-app'}]
    }
...
@pytest.mark.asyncio
async def test_performance_optimization_event_emission():
    """Test that appropriate events are emitted during mapping"""
    agent = PerformanceOptimizerAgent()
    
    task = {
        'project_id': 'project-707',
        'performance_metrics': [{'name': 'app-1'}, {'name': 'app-2'}]
    }
    ...
    assert 'performance_optimization.started' in event_types
    assert 'performance_optimization.completed' in event_types


@pytest.mark.asyncio
async def test_performance_optimization_error_event():
